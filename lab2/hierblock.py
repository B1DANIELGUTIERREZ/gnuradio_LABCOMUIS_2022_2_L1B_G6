...
class hierblock(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._AD_range = Range(0, 12, 1, 1, 200)
        self._AD_win = RangeWidget(self._AD_range, self.set_AD, "'AD'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._AD_win)
