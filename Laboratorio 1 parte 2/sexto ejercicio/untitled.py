...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_b_range = Range(1000, 40000, 1000, 1000, 200)
        self._freq_b_win = RangeWidget(self._freq_b_range, self.set_freq_b, 'frequencyB', "counter_slider", float)
        self.top_grid_layout.addWidget(self._freq_b_win)
        self._freq_a_range = Range(1000, 40000, 1000, 1000, 200)
        self._freq_a_win = RangeWidget(self._freq_a_range, self.set_freq_a, 'frequencyA', "counter_slider", float)
