...
# Title: lab1_segundap_punto3
# Author: Daniel_Gutierrez_J1B_G6
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "lab1_segundap_punto3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab1_segundap_punto3")
        ...
        self._f_corte_win = RangeWidget(self._f_corte_range, self.set_f_corte, 'frecuencia corte', "counter_slider", float)
        self.top_grid_layout.addWidget(self._f_corte_win)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\Usuario\\Desktop\\Yo quiero un Heroe\\Control 1\\Tercer Corte\\tercer ejercicio\\session52_quevedobzrp.wav', True)
        ...
        self.connect((self.band_pass_filter_0, 0), (self.rational_resampler_xxx_2, 0))
